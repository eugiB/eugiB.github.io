...
(function (Aufgabe5) {
    ...
    function createHTML() {
        ...
        for (let i = 0; i < data["lametta"].length; i++) {
    ...
    //
    // let finishedorder: HTMLDivElement = <HTMLDivElement>document.gentBy;
    //    finishedorder.innerHTML = "Treesort: " + 
})(Aufgabe5 || (Aufgabe5 = {}));
