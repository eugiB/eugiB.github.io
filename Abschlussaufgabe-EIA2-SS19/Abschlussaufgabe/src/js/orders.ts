namespace IceAge2019 {
    ...
    function newSingleOrder(singleOrderJSON: JSON, key: string): HTMLDivElement {
        ...
        const ordersWrapper: HTMLDivElement = <HTMLDivElement>document.getElementById("order-wrapper");
        const divSingleOrder: HTMLElement = newElement("div", "single-order col-12 mb-5", ordersWrapper);
        const divBorder: HTMLElement = newElement("div", "m-2 border-thin px-4 py-5", divSingleOrder);
        ...
        let headlineText: string = "Bestellung Nr. " + (parseInt(key) + 1);
        ...
        const closeButton: HTMLButtonElement = <HTMLButtonElement>newElement("button", "mr-3 btn btn-info font-weight-bold", divButton);
        ...
        const numberDescription: HTMLElement = newElement("div", "col-2", divDescriptionRow);
        numberDescription.innerHTML = "Nr.";

        const articleDescription: HTMLElement = newElement("div", "col-7", divDescriptionRow);
        articleDescription.innerHTML = "Artikel";

        const priceDescription: HTMLElement = newElement("div", "col-3 text-right", divDescriptionRow);
        ...
        const placeholderTotal: HTMLElement = newElement("div", "col-9 text-danger font-weight-bold", divTotal);
    ...
    function handleStateDeletedOrder(_event: Event): void {
    ...
    export function deleteSingleOrder(elementToRemove: HTMLElement): void {
        ...
        const orderId: string = orderID[index];
