namespace IceAge2019 {
    ...
    function buildStructure(configData: JSON): void {
        ...
        function newCategory(_category: JSON): void {
            const categoryWrapper: HTMLElement = newElement("div", "category mb-1 border-bottom pb-5", categoriesWrapper);
            const headline: HTMLElement = newElement("h3", "pb-1", categoryWrapper);
        ...
        function newRadioCategory(_category: JSON): void {
            const categoryWrapper: HTMLElement = newElement("div", "category mb-1 border-bottom pb-5", categoriesWrapper);
            const headline: HTMLElement = newElement("h3", "pb-3", categoryWrapper);
            headline.innerHTML = _category.title;
            ...
            for (let item in _category["items"]) {
                ...
                const divItemRow: HTMLElement = newElement("div", "px-3 py-2 mb-1 border rounded item-row", divContainer);
